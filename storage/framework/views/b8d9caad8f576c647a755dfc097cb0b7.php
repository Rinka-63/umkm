        ...
        <main>
                ...
                <?php if(request()->is('kasir/beranda')): ?>
                    <div class="row g-4 mb-4">
                        <div class="col-md-3">
                            <a href="<?php echo e(route('kasir.barang')); ?>" class="text-decoration-none text-reset">
                        ...
                        <div class="col-md-3">
                            <a href="<?php echo e(route('kasir.riwayat')); ?>" class="text-decoration-none text-reset">
                                <div class="stat-card d-flex justify-content-between">
                                    <div>
                        ...
                        <div class="col-md-3">
                            <a href="<?php echo e(route('kasir.barang', ['status' => 'kritis'])); ?>" class="text-decoration-none text-reset">
